  ...
  <body>
    <div class="nav">
      ...
      <ul id="item">
        ...
        <li><a href="ngo_display.php">NGO's</a></li>
        <li><a href="needy.php">Need_meds</a></li>
        <li>
          <a href="#">My Profile</a>
          <ul>
            <li><a href="history.php">History</a></li>
            <li><a href="donaters.html">Donations</a></li>
            <li><a href="need_med.php">Need_med</a></li>
    ...
    <div class="details">
      <div class="one">
        ...
        <a href="./ngo_registration.php">Register Now</a>
      </div>
      <div class="two">
        <p>
