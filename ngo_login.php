...
if(isset($_POST['login']))
{
  ...
  $sql="SELECT * FROM ngos WHERE email='$email' && password='$password'";
  include_once('db.php');
  ...
  else
  {
    ...
    Please enetr correct Email/Password!
    </div>';
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 text-center mb-5">
            <h2 class="heading-section">NGO Login</h2>
          </div>
        </div>
        <div class="row justify-content-center">
              ...
              <form action="" method="POST" class="login-form">
                ...
                <div class="form-group mt-4">
                  <div class="w-100 text-center">
                    <p class="mb-1">
                      Don't have an account? <a href="ngo_registration.php">Sign Up</a>
                    </p>
